  ...
  <div class="container-fluid">
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      <div class="row">
          ...
          <p class="mt-5">Kami percaya bahwa pengetahuan adalah kekuatan, dan setiap individu berhak mendapatkan akses ke sumber daya pendidikan yang berkualitas. 
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">mang akib</div>
        <div class="card-body">
          <h5 class="card-title">Student smkn negri 01 wakanda</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">jalan wakanda no 9</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">create by<a href="" class="text-decoration-none"> akib</a>  2024</p>
        </div>
      </div>
    </footer>
